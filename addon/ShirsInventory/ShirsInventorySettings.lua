...
function ShirsInventory_RefreshCategoryManager()
  ...
  if categoryManagerFrame.collapseEmptySlots then
...
local function ShirsInventory_CreateCategoryManager()
  ...
  frame.collapseEmptySlots = CreateFrame("CheckButton", nil, frame, "UICheckButtonTemplate")
  frame.collapseEmptySlots:SetWidth(24)
  frame.collapseEmptySlots:SetHeight(24)
  frame.collapseEmptySlots:SetPoint("TOPLEFT", frame, "TOPLEFT", 24, -531)
  frame.collapseEmptySlots.label = frame.collapseEmptySlots:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
  frame.collapseEmptySlots.label:SetPoint("LEFT", frame.collapseEmptySlots, "RIGHT", 4, 0)
  frame.collapseEmptySlots.label:SetWidth(300)
  frame.collapseEmptySlots.label:SetHeight(24)
  frame.collapseEmptySlots.label:SetJustifyH("LEFT")
  frame.collapseEmptySlots.label:SetText("Collapse Empty Slots to one slot")
  frame.collapseEmptySlots:SetScript("OnClick", function()
    ShirsInventory_SetCollapseEmptySlots(this:GetChecked() and true or false)
    ShirsInventory_RefreshCategoryManager()
    if ShirsInventory_Update then ShirsInventory_Update() end
  end)
