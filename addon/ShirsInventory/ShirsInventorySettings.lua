...
local function ShirsInventory_CreateSettingsFrame()
  ...
  frame.junk = ShirsInventory_CreateFeatureCheck(frame, "Sell Junk + manual junk marks", "junk", -182)
  frame.autoSellJunk = ShirsInventory_CreateFeatureCheck(frame, "Auto-sell gray + manually marked items at vendors", "autoSellJunk", -222)
  frame.showRarityBoxes = ShirsInventory_CreateFeatureCheck(frame, "Show quest and rarity borders on items", "showRarityBoxes", -252)
  frame.useCoinIcons = ShirsInventory_CreateFeatureCheck(frame, "Use coin icons for currency (off = g/s/c text)", "useCoinIcons", -282)
  ...
  frame.bagProviderText:SetPoint("TOPLEFT", frame, "TOPLEFT", 24, -342)
  ...
  frame.bagProviderButton:SetPoint("TOPLEFT", frame, "TOPLEFT", 24, -367)
